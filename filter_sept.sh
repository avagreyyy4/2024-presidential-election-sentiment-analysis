...
combined_output="/c/Users/agrey25/Desktop/september_data_combined.csv"

# ==== SETUP ====
echo "[START] Searching all directories for September chunk files"
temp_header_written=false

# ==== FIND AND COMBINE ====
find "$search_dir" -type f -name "september_chunk_*.csv.gz" | while read file; do
...
echo "[DONE] All September chunk files combined into: $combined_output"
