...
combined_output="/c/Users/agrey25/Desktop/november_data_combined.csv"

# ==== SETUP ====
echo "[START] Searching all directories for November chunk files"
temp_header_written=false

# ==== FIND AND COMBINE ====
find "$search_dir" -type f -name "november_chunk_*.csv.gz" | while read file; do
...
echo "[DONE] All November chunk files combined into: $combined_output"
